...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnObjectSpawnCompletedSignature, AActor*);
...
DECLARE_MULTICAST_DELEGATE(FOnDeselectPlacementObjectSignature);
...
DECLARE_MULTICAST_DELEGATE(FOnCopySignature);
DECLARE_MULTICAST_DELEGATE(FOnMoveSignature);
